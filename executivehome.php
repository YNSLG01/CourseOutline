...
<body>
    ...
    <div class="main">
        <center>
            ...
            <br><br>
            <div class="pic">
                <td1><a href="e_approve.php"><button><img src="image/666666.png" width="180" height="180"><br>การอนุมัติ</button></a></td1>
                <td2><a href="e_history.php"><button><img src="image/passport.png" width="180" height="180"><br>ประวัติการอนุมัติ</button></a></td2>
                <pre></pre>
                <td3><a href="e_notify.php"><button><img src="image/notify.png" width="180" height="180"><br>การแจ้งเตือน</button></a></td3>
            </div>
        </center>
    </div>
